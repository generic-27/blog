import{e as $,D as d,A as k}from"../chunks/article-main-header.5ca7b7b1.js";import{s as b,n as T}from"../chunks/scheduler.e108d1fd.js";import{S as y,i as _,g as p,r as w,s as P,h as m,j as S,u as A,c as D,y as E,f as u,k as f,a as C,v as I,x as g,d as l,t as h,w as x,b as O,p as j}from"../chunks/index.2b92d2ca.js";function z({params:o}){switch(o.slug){case d:return{path:d};default:throw $(404,"Not found")}}const F=Object.freeze(Object.defineProperty({__proto__:null,load:z},Symbol.toStringTag,{value:"Module"}));function N(o){let t,s,e,i,a=`<h1>Describing cloud concepts</h1> <div class="blog-paragraph">With software development I have always felt like I start my journey in a chopper and I get
			...
			bracket. The idea is to pay for what you use.</div>`,c;return s=new k({}),{c(){t=p("div"),w(s.$$.fragment),e=P(),i=p("div"),i.innerHTML=a,this.h()},l(r){t=m(r,"DIV",{class:!0});var n=S(t);A(s.$$.fragment,n),e=D(n),i=m(n,"DIV",{class:!0,"data-svelte-h":!0}),E(i)!=="svelte-16ac98p"&&(i.innerHTML=a),n.forEach(u),this.h()},h(){f(i,"class","blog-text-container"),f(t,"class","describing_cloud_concepts_container svelte-9zw7n7")},m(r,n){C(r,t,n),I(s,t,null),g(t,e),g(t,i),c=!0},p:T,i(r){c||(l(s.$$.fragment,r),c=!0)},o(r){h(s.$$.fragment,r),c=!1},d(r){r&&u(t),x(s)}}}class L extends y{constructor(t){super(),_(this,t,null,N,b,{})}}function v(o){let t,s;return t=new L({}),{c(){w(t.$$.fragment)},l(e){A(t.$$.fragment,e)},m(e,i){I(t,e,i),s=!0},i(e){s||(l(t.$$.fragment,e),s=!0)},o(e){h(t.$$.fragment,e),s=!1},d(e){x(t,e)}}}function M(o){let t,s,e=o[0].path===d&&v();return{c(){t=p("div"),e&&e.c(),this.h()},l(i){t=m(i,"DIV",{class:!0});var a=S(t);e&&e.l(a),a.forEach(u),this.h()},h(){f(t,"class","blog-container")},m(i,a){C(i,t,a),e&&e.m(t,null),s=!0},p(i,[a]){i[0].path===d?e?a&1&&l(e,1):(e=v(),e.c(),l(e,1),e.m(t,null)):e&&(j(),h(e,1,1,()=>{e=null}),O())},i(i){s||(l(e),s=!0)},o(i){h(e),s=!1},d(i){i&&u(t),e&&e.d()}}}function V(o,t,s){let{data:e}=t;return o.$$set=i=>{"data"in i&&s(0,e=i.data)},[e]}class B extends y{constructor(t){super(),_(this,t,V,M,b,{data:0})}}export{B as component,F as universal};
